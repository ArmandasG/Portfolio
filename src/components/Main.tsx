...
function Main() {
  return (
    ...
    <div className='flex items-center flex-col gap-y-2'>
            ...
            <p className='text-sm tracking-wide text-gray-800 max-w-[65%] text-center'>I’m a junior full stack developer specializing in building digital experiences. Currently, I’m focused on building web applications and am currently working full time as a Full Stack Developer.</p>
